...
import { MockedObject, afterEach, beforeEach, describe, expect, test, vi } from 'vitest'
import { Request, getSubscriptionRequests, requestEvent$, startSubscriptionChannel } from './subscriptionRequests'
...
describe('subscriptionRequests', () => {
    ...
    test('requestEvent$', async () => {
        ...
        const buffer2Promise = firstValueFrom(requestEvent$.pipe(bufferCount(numberToRemove), take(1)))
